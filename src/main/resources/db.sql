...
VALUES (0, '电信网络诈骗受害人数最多的群体是？', '据国家反诈中心公布数据显示，在2021年电信网络诈骗的受害者中，18至35岁占比65.5%。年轻人才是电信网络诈骗的主要受害群体。'),
       (0, '居住在安庆市大观区的老王吃完晚饭正在客厅看电视，12岁的儿子小明忽然说要拿他手机上网买一本参考资料，过了几分钟，小明说已经选好了资料，要他刷脸付款。老王赶紧用手捂住了脸，并责令小明把手机关机。老王的做法对吗？', '骗子先用免费赠送游戏皮肤吸引小孩子，然后忽悠他们去借父母的手机扫付款二维码，并让父母刷脸支付。请各位家长千万不要随意告知子女自己的支付密码，也不要随意答应刷脸支付。'),
       (1,'安庆市大观区的马大姐接到了一个自称是大观区公安局民警的电话，在接下来的通话中，这个“民警”不断让马大姐按照要求做一些事，请问下面哪些事充满了风险？','冒充公检法虽然是老骗术，但是招数却经常翻新，以上四类都是犯罪团伙经常使用的手法，请大家一定提高警惕。'),
       (0,'就读于安庆某校的小萌今年23岁，马上大四毕业，但却找不到合适的工作。有个同学告诉他，只要去办理银行卡、电话卡，然后申办营业执照和对公账户，每办一套卖给别人转账就可以得到3000元奖励金，如果协助处理后续解冻等事宜，酬劳翻倍。小萌觉得找到了一份好工作。请问小萌的做法可能会引发什么后果？','为他人提供支付结算工具的行为，触犯了刑法第287条帮助信息网络犯罪活动罪。所有快速赚钱的办法都写在《刑法》里，比找不到工作更可怕的，是找到一份走向监狱的工作。'),
       (0,'我们常说的“杀猪盘”指的是','杀猪盘是婚恋投资类诈骗的统称。骗子先伪装身份与受害人谈情说爱，随后再拉着受害人去投做各类投资。骗子把那些感情寂寞的人叫做猪，把建立恋爱关系的过程叫做养猪，把最后的诈骗环节叫做杀猪。'),
       (0,'目前东南亚部分国家已经成为国内诈骗分子行骗的天堂，他们通过偷渡方式从云南到接壤的部分国家，逃避国内警方的追踪和打击，其中缅甸的民地武控制地区是不少骗子的心水之选。那么，你认为从云南边境偷渡到缅甸民地武控制地区需要多少钱？','蛇头利用云南边境特殊的地理形势和民地武地区特殊的管理体制，只需200元就能成功带人偷渡，让国内警察望线（边境线）兴叹。'),
       (0,'居住在安庆市大观区的刘小姐半个月前在网上认识了一个香港工程师jeff并坠入爱河，jeff说他掌握了一个赌博网站的漏洞，要求一起投注致富。一个星期左右，刘小姐输了20多万，jeff也消失不见。刘小姐觉得对方有问题，但是觉得自己的行为是赌博，便不敢去报案。请问刘小姐的想法是否正确？','这属于典型的杀猪盘，应立即去报案。但如果不是杀猪盘，确实涉嫌网络赌博，也将接受相应的处罚。所以，在此提醒所有人：远离任何赌博，特别是网络赌博，不是被骗就是被抓。'),
       (1,'电信诈骗已经成为一个完善的产业链条，骗子之间的分工也越来越明确，诈骗界的“黑话”语系也逐渐形成。下列诈骗界的“黑话”与解释对应正确的是：','目前已知的诈骗界黑话有几十个之多，懂5个就算是反诈骗专家！');
